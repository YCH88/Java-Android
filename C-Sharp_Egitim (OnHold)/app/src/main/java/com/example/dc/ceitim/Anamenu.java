...
public class Anamenu extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.bolum1) {
            Intent bolum1=new Intent(Anamenu.this,programlamatemelleri.class);
            startActivity(bolum1);

        } else if (id == R.id.bolum2) {
Intent bolum2=new Intent(Anamenu.this,degiskentipleri.class);
startActivity(bolum2);

        }
        else if(id==R.id.bolum3)
        {
              Intent bolum3 = new Intent(Anamenu.this,kontrolmekanizmalari.class);
